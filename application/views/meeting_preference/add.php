                ...
                <div class="col-9">
                    <div class="card-box">
                        <div class="row">
                            <div class="col-12">
                                <div class="p-20">
                                    <form id="preference_add_edit" enctype="multipart/form-data" class="form-horizontal" role="form" name="add_preference" method="post">
        ...
        $field_value = $temp_value;
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-10">
                                                ...
                                                <small style="display: block;">Refer this <a href="https://icons8.com/icon/set/office/material" target="_blank">link</a> for more icons</small>
                                            </div>
