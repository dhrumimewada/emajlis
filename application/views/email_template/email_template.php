                            ...
                            <tbody>
                                <tr>
                                    <td valign="top" width="60" align="center">
                                        <img src="<?php echo base_url().'assets/images/logo/logo.png'; ?>" alt="Logo" title="Logo" width="100" height="60" data-max-width="100">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<!-- =============== END HEADER =============== -->
<!-- =============== START BODY =============== -->
<div class='contentEditable' style='text-align: center; margin-top: 1.5rem;'>
<?php
                                ...
                                <td>
                                    <div class='contentEditableContainer contentTextEditable'>
                                        <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                            <p>
                                                &#169; 2018 Emajlis - <span class="d-none d-sm-inline-block"> Crafted by Excellent WebWorld</span>.
                                            </p>
                                        </div>
                                    </div>
                                </td>
