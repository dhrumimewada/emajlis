...
<div class="content-page">
                ...
                <div class="col-9">
                    <div class="card-box">
                        <div class="row">
                            <div class="col-12">
                                <div class="p-20">
                                    <form enctype="multipart/form-data" id="add_edit_advertise" class="form-horizontal" role="form" name="editadvertise" method="post">
    ...
    ?>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-10">
                                                <label class="control-label required">Advertise Image</label>
                                            ...
                                            <div class="col-md-2" style="padding-top: 30px;">
                                              <?php if(!empty($advertise->image)){
                                                $img_src = base_url().$this->config->item("advertisement_path"). $advertise->image;
                                              }
                                              else{
                                                $img_src = base_url().'assets/images/advertisements/member-noimg.png';
                                              } ?>
                                                <img id="preview-img" src="<?php echo $img_src; ?>" alt="vendor partners image" style="height: auto; width: 50px;" />
                                            </div>
