...
<div class="content-page">
                ...
                <div class="col-9">
                    <div class="card-box">
                        <div class="row">
                            <div class="col-12">
                                <div class="p-20">
                                    <form id="hashtag_add_edit" class="form-horizontal" role="form" name="edithashtag" method="post">
                                      <input type="hidden" name="id" value="<?php echo $hashtag->id; ?>">
    ...
    if (isset($temp_value) && !empty($temp_value)) {
        ...
        $field_value = htmlspecialchars($hashtag->tag_name);
    }
    ?>
    ...
    if (isset($temp_value) && !empty($temp_value)) {
        ...
        $field_value = $hashtag->newsfeed_url;
    }
    ?>
    ...
    if (isset($temp_value) && !empty($temp_value)) {
        ...
        $field_value = $hashtag->description;
    }
    ?>
