...
<div class="content-page">
                ...
                <div class="col-9">
                    <div class="card-box">
                        <div class="row">
                            <div class="col-12">
                                <div class="p-20">
                                    <form id="industry_add_edit" class="form-horizontal" role="form" name="add_industry" method="post">
    ...
    if (isset($temp_value) && !empty($temp_value)) {
        $field_value = $temp_value;
                                                    ...
                                                    <input id="name" name="name" type="text" class="form-control" placeholder="Enter industry name" autocomplete="off" value="<?php  echo $field_value; ?>">
